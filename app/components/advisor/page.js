...
const advisorData = [
  ...
  },
  {
    ...
    pronoun: "",
    name: "Akhil Tripathi",
    designation: "Mentor, Qualified NEST,",
    university: "Master's Student at NISER",
  ...
  },
  {
    ...
    pronoun: "",
    name: "Vivek Dwivedi",
    designation: " Mentor, Qualified NEST, JEE",
    university: "Master's Student at NISER",
    links: "",
  },
  {
...
const page = () => {
  ...
  return (
    <div className='text-center align-center '>
      <h1 className='text-center md:text-5xl text-2xl font-bold py-3  bg-gradient-to-t from-[#234eb0] to-[#ad56df] text-transparent  bg-clip-text'>
        Mentor & Advisor</h1>
      <hr />
        ...
        {advisorToDisplay.map((advisor) => (
          <div
            ...
            <img 
              ...
              className='rounded-full mx-auto mb-3 object-scale-down h-40 w-40'  />
      ...
      <button
        ...
        className='bg-gradient-to-tr md:text-xl text-sm px-3 py-1 my-4 rounded-xl from-[#5907fe] to-[#e2a7cd] text-white'
      >
