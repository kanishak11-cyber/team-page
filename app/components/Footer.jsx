  ...
  return (
    <div className="bg-[url('https://files.sciastra.com/footermain.jpg')] bg-cover bg-no-repeat text-white pt-3">
      <div className='md:px-20 px-4'>
        ...
        <h1>&copy; SciAstra</h1>
        <ul className='md:text-xl text-sm flex flex-col gap-4 pt-4'>
        ...
        <div className='flex md:flex-row flex-col md:justify-evenly justify-center gap-3 items-center md:text-xl text-xs py-10'>
      ...
      <div className='text-center text-white bg-black py-4 md:text-xl text-xs'>
